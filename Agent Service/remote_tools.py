...
#RAG_URL = "http://127.0.0.1:8001/retrieve" #Unfortunately, the URL to RAG microservice is not working when inside of a container.
#RAG_URL = "http://rag:8001/retrieve"
#SENTIMENT_URL = "http://sentiment:8000/classify"
SENTIMENT_URL = "http://python-sentiment_tool_service:8000/classify"
RAG_URL = "http://python-rag_service:8001/retrieve"
